...
if (
    ...
    /*
     * Form verilerini yeniden doldurabilmek için
     * önce kullanıcı girdilerini alıyoruz.
     */
    ...
    */ elseif (!isAdmin()) {
        /*
         * Guest burada durdurulur.
         *
         * Görsel yüklenmez.
         * Veritabanına hiçbir kayıt eklenmez.
         * Form yine normal şekilde görünür.
         */

        $msg = getMessage(
            'Compte de démonstration : l’ajout de livres est désactivé.',
            'error'
        );
    }
    ...
    */ elseif (!$conn instanceof PDO) {
    ...
    } elseif (mb_strlen($addData['title']) > 255) {
        $msg = getMessage(
            'Le titre du livre est trop long.',
            'error'
        );
    } elseif ($addData['idCategory'] < 1) {
        $msg = getMessage(
            'Veuillez sélectionner une catégorie.',
            'error'
        );
    } elseif (
        mb_strlen($addData['writer']) > 255
                ...
                if (
                    ...
                    if (
                        ...
                        if (
                            ...
                            /*
                             * Veritabanında dosya sisteminin
                             * tam yolunu değil, göreli yolu
                             * saklıyoruz.
                             */
        ...
        */
        ...
        if ($msg === null) {
            ...
            /*
             * Veritabanı kaydı başarısız olduysa,
