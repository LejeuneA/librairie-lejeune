...
if (
    ...
    if (
        ...
        $msg = getMessage(
            'Compte de démonstration : l’ajout de cadeaux est désactivé.',
            'error'
        );
        ...
        if ($msg === null) {
            ...
            if ($addResult === true) {
                $_SESSION['message'] = getMessage(
                    'Le cadeau a été ajouté avec succès.',
                    'success'
                );
            ...
            $msg = getMessage(
                'Erreur lors de l’ajout du cadeau. Veuillez réessayer.',
                'error'
            );
        }
    }
...
<head>
    <?php displayHeadSection('Ajouter un cadeau'); ?>
</head>
