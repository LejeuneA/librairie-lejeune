...
if (
    ...
    if (
        ...
        $msg = getMessage(
            'Compte de démonstration : la modification des articles de papeterie est désactivée.',
            'error'
        );
        ...
        */
        ...
        if ($msg === null) {
            $updateResult = updatePapeterieDB(
                $conn,
                [
                    'idPapeterie' =>
                    $idPapeterie,
            ...
            if ($updateResult === true) {
                ...
                header(
                    'Location: edit-papeterie.php?idPapeterie='
                        . $idPapeterie
                );
...
<head>
    <?php
    displayHeadSection('Éditer une papeterie');
    ?>
</head>
...
<body>
    ...
    <main class="edit-content">
        ...
        <div class="edit-form container">
            ...
            <form
                action="edit-papeterie.php?idPapeterie=<?= $idPapeterie ?>"
                method="post"
                ...
                <a
                    class="btn-primary"
                    href="article-papeterie.php?idPapeterie=<?= $idPapeterie ?>">
                    Afficher
                </a>
